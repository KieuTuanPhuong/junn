  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-8 mt-12 lg:min-h-screen">
        <h2
          data-reveal
          className="text-h2 lg:text-[36px]! text-black font-medium! uppercase"
        >
      ...
      <div
        data-reveal
        className="relative -mx-6 md:-mx-10 lg:mx-0 lg:absolute z-10 lg:left-0 lg:bottom-0 top-[8%] w-screen h-auto lg:h-[60vh] bg-amber-300 mt-8 flex items-center justify-center text-neutral-400 overflow-hidden"
      >
        <MuxVideo
          ...
          className={`w-full h-full transition-opacity duration-1000 ease-out scale-200 object-cover inset-0 ${
